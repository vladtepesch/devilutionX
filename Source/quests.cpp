...
{
	QuestBook::instance().draw(out);
}

void StartQuestlog()
{
	QuestBook::instance().open();
}

void QuestlogUp()
{
	QuestBook::instance().selectionUp();
}

void QuestlogDown()
{
	QuestBook::instance().selectionDown();
}

void QuestlogEnter()
{
	QuestBook::instance().playEntry();
}

void QuestlogESC()
{
	QuestBook::instance().processClick();
}
